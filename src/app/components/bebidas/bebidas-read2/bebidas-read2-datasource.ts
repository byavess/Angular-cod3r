...
/**
 * Data source for the Bebidas view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class BebidasRead2DataSource extends DataSource<Bebidas> {
  data: Bebidas[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: Bebidas[]): Bebidas[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Bebidas[]): Bebidas[] {
